...
export function MemberPreviewModal({ isOpen, onClose, product }: MemberPreviewModalProps) {
      ...
      <div className="bg-card rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Spesifikasi Mobil</h3>
          ...
          {product.detailedSpecs.catatan && (
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              <h3 className="text-sm font-bold mb-2">Catatan</h3>
              <p className="text-sm text-foreground">{product.detailedSpecs.catatan}</p>
            </div>
          )}

          <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 py-6 text-base font-semibold tracking-wide uppercase">
